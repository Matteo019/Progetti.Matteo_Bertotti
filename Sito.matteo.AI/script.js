...
const translations = {
    it: {
        ...
        "exp-year": "Presente",
        "exp-desc": "Sviluppo e manutenzione di software gestionali ERP presso Metline, software house ICT con sede a San Martino Buon Albergo (VR) e parte del Gruppo Maestrale. Mi occupo della creazione di soluzioni verticali per settori come Vino (ENO Software), Fashion (Comet Software) e Depositi Petroliferi (GECO Software), oltre a gestionali su misura, piattaforme SaaS e applicazioni in locale. Lavoro con l'ERP Panthera per la gestione integrata dei processi aziendali \u2014 dalla contabilit\u00e0 alla logistica, dal CRM alla gestione documentale. Contribuisco inoltre allo sviluppo di servizi cloud, infrastrutture server e integrazioni di sistema per le PMI.",
        "exp-stack-title": "Stack Tecnologico:",
        "exp-stack-db": "Database Management",
        "exp-stack-erp": "Gestionali ERP",
        "exp-stack-vertical": "Soluzioni Verticali",
        "exp-stack-integration": "Integrazione Sistemi",
    ...
    en: {
        ...
        "exp-year": "Present",
        "exp-desc": "Development and maintenance of ERP management software at Metline, an ICT software house based in San Martino Buon Albergo (VR) and part of the Maestrale Group. I work on building vertical solutions for industries such as Wine (ENO Software), Fashion (Comet Software) and Petroleum Depots (GECO Software), as well as custom management systems, SaaS platforms, and on-premise applications. I work with Panthera ERP for integrated business process management \u2014 from accounting to logistics, CRM to document management. I also contribute to cloud services development, server infrastructure, and system integrations for SMEs.",
        "exp-stack-title": "Tech Stack:",
        "exp-stack-db": "Database Management",
        "exp-stack-erp": "ERP Systems",
        "exp-stack-vertical": "Vertical Solutions",
        "exp-stack-integration": "System Integration",
