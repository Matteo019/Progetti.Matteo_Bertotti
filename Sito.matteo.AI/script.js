...
const translations = {
    it: {
        ...
        "exp-year": "Presente",
        "exp-desc": "Mi occupo della creazione di soluzioni verticali, oltre a gestionali su misura, piattaforme SaaS e applicazioni in locale. Lavoro con l'ERP Panthera per la gestione integrata dei processi aziendali, dalla contabilit\u00e0 alla logistica, dal CRM alla gestione documentale.",
    ...
    en: {
        ...
        "exp-year": "Present",
        "exp-desc": "I build vertical solutions, custom management systems, SaaS platforms, and on-premise applications. I work with Panthera ERP for integrated business process management, from accounting to logistics, CRM to document management.",
